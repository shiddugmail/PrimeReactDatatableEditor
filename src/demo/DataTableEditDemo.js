    ...
    return (
      <Button
        ...
        onClick={() => {
          ...
          setModifyData(rowData);
          Object.keys(rowData).map((value) => console.log(value));
          setDisplayBasic(true);
          document.getElementById("products2").children[0].children[0].focus();
          console.log(rowData);
          console.log(
            document.getElementById("products2").children[0].children[0]
              .children[0]
          );
          console.log(
            document.getElementById("products2").children[0].children[0]
    ...
    <div className="datatable-editing-demo">
      ...
      >
        <div className="grid p-fluid">
          {modifyData ? (
            Object.keys(modifyData).map((key, value) => {
              const readonly = key === "Editable" ? modifyData[key] : null;
